...
<%-- 引入Highcharts --%>
<script src="<%=contextPath%>/jslib/Highcharts-3.0.5/js/highcharts.js" type="text/javascript" charset="utf-8"></script>
<script src="<%=contextPath%>/jslib/Highcharts-3.0.5/js/modules/exporting.js" type="text/javascript" charset="utf-8"></script>
<%-- 引入Highcharts扩展 --%>
...
<script type="text/javascript" src="<%=contextPath%>/jslib/plupload_1_5_7/plupload/js/i18n/zh-CN.js?version=<%=version%>"></script>
